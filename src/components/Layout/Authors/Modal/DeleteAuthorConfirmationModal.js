...
function DeleteAuthorConfirmationModal({ confirmationModalOpen, handleConfirmationModalOpen, handleConfirmationModalClose, handleConfirmationSubmit }) {
...
export default DeleteAuthorConfirmationModal;